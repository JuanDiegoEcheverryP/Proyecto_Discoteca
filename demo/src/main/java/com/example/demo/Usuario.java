...
public class Usuario {
    ...
    * @generated
    */
    private HistorialBusqueda historialVisitas;
    ...
    */
    ...
    public Usuario(Integer idUsuario, String nombreUsuario, String contrasena, String nombre, String apellido, String tipoDocumento, Integer numeroDocumento, Boolean estadoUsuario, HistorialBusqueda historialBusqueda, HistorialBusqueda historialVisitas, Set<Reserva> reserva, Set<Dueno> dueno) {
    ...
    * @generated
    */
    private HistorialBusqueda getHistorialBusqueda() {
    ...
    * @generated
    */
    private HistorialBusqueda setHistorialBusqueda(HistorialBusqueda HistorialBusqueda) {
